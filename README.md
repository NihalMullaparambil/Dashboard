...
```
cd existing_repo
git remote add origin https://git.rwth-aachen.de/franke/folivora_dashboard.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.rwth-aachen.de/franke/folivora_dashboard/-/settings/integrations)
